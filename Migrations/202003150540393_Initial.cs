    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.EmployeeModels", t => t.Employee, cascadeDelete: true)
                .Index(t => t.Employee);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    DthEmployee = c.Int(nullable: false),
                    DthTimeEntered = c.DateTime(nullable: false),
                    DthTimeCleared = c.DateTime(),
                })
                .PrimaryKey(t => t.DthId)
                .ForeignKey("dbo.EmployeeModels", t => t.DthEmployee, cascadeDelete: true)
                .Index(t => t.DthEmployee);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BreakModels", "Employee", "dbo.EmployeeModels");
            ...
            DropIndex("dbo.BreakModels", new[] { "Employee" });
